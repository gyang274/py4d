...
+ `apply` is the most general purpose GroupBy method: 
    ...
    - _`apply` splits the object being manipulated into pieces, invokes the passed function on each piece, and then attempts to concatenate the pieces together (split-apply-combine)_.
